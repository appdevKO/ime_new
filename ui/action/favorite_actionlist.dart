  ...
  Widget build(BuildContext context) {
    return Consumer<ChatProvider>(
      builder: (context, value, child) {
        return value.favorite_actionlist!.isNotEmpty
            ? SmartRefresher(
                enablePullDown: true,
                enablePullUp: true,
                ...
                child: value.favorite_actionlist != null &&
                        ...
                        value.favorite_actionlist![0].actionlist != null
                    ? value.favorite_actionlist![0].actionlist!.isNotEmpty
                        ? ListView.separated(
                            ...
                            itemCount:
                                value.favorite_actionlist![0].actionlist.length,
                          )
                        : Container(
                            child: Center(
    ...
    return Consumer<ChatProvider>(
      builder: (context, value, child) {
        return Container(
          ...
          child: Container(
            height: value.favorite_actionlist![0].actionlist![widget.index!]
                            .image_sub !=
                        '' &&
                    value.favorite_actionlist![0].actionlist![widget.index!]
                            .image_sub !=
                        null
                ? 340
                : 190,
            child: Column(
              ...
              children: [
                GestureDetector(
                    ...
                    child: Row(
                      ...
                      children: [
                            ...
                            CircleAvatar(
                              ...
                              child: CircleAvatar(
                                ...
                                backgroundImage: value
                                                .favorite_actionlist![0]
                                                .actionlist![widget.index!]
                                                .avatar ==
                                            '' ||
                                        value
                                                .favorite_actionlist![0]
                                    ...
                                    ? AssetImage('assets/default/sex_man.png')
                                        as ImageProvider
                                    : NetworkImage(value.favorite_actionlist![0]
                                        .actionlist[widget.index!].avatar),
                              ),
                            ),
                            Container(
                              width: 8,
                                ...
                                Text(
                                  value
                                          ...
                                          value
                                              ...
                                              ''
                                      ? '不詳'
                                      : '${value.favorite_actionlist![0].actionlist![widget.index!].nickname}',
                                  style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 16,
                                      ...
                                      Text(
                                        value
                                                ...
                                                value
                                                    ...
                                                    ''
                                            ? '不詳'
                                            : '${value.favorite_actionlist![0].actionlist![widget.index!].area}',
                                        style: TextStyle(
                                            color: Colors.grey,
                                            fontSize: 12,
                                            fontWeight: FontWeight.w700),
                        ...
                        Column(
                          children: [
                            //是我的動態 要可以編輯 或是刪除
                            value.favorite_actionlist![0]
                                        .actionlist![widget.index!].memberid ==
                            ...
                            Text(
                              value
                                          ...
                                          .createTime !=
                                      null
                                  ? '${DateFormat('yyyy/MM/dd').format(value.favorite_actionlist![0].actionlist![widget.index!].createTime)}'
                                  : '--/--/--',
                  ...
                  onTap: () {
                    if (value.favorite_actionlist![0].actionlist![widget.index!]
                            .account !=
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) => OtherProfilePage(
                                    chatroomid: value.favorite_actionlist![0]
                                        .actionlist[widget.index!].memberid,
                                  )));
                    } else {
                      print('同一人');
                    ...
                    child: Container(
                      ...
                      child: RichText(
                        ...
                        text: TextSpan(
                            ...
                            text: value.favorite_actionlist![0]
                                            .actionlist![widget.index!].text !=
                                        '' &&
                                    value.favorite_actionlist![0]
                                            .actionlist![widget.index!].text !=
                                        null
                                ? '${value.favorite_actionlist![0].actionlist![widget.index!].text}'
                                : '(無內文)'),
                      ),
                    ),
                  ),
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) => ActionDetailPage(
                                  TheAction: value.favorite_actionlist![0]
                                      .actionlist![widget.index!],
                                )));
                  },
                ),
                ...
                Padding(
                  ...
                  child: value.favorite_actionlist![0]
                                  .actionlist![widget.index!].image_sub !=
                              '' &&
                          value.favorite_actionlist![0]
                                  .actionlist![widget.index!].image_sub !=
                              null
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                    image: NetworkImage(
                                        '${value.favorite_actionlist![0].actionlist![widget.index!].image_sub}'),
                                    fit: BoxFit.cover)),
                          ),
                          onTap: () {
                            Navigator.push(
                        ...
                        children: [
                          IconButton(
                              icon: Icon(
                                Icons.favorite,
                                size: 18,
                                color: value.favorite_actionlist![0]
                                        .actionlist![widget.index!].like_list
                                        .contains(
                                            value.remoteUserInfo[0].memberid)
                                    ? Colors.red
                                    : Colors.grey,
                            ...
                            child: Text(
                              value
                                      ...
                                      value
                                              ...
                                              .like_num !=
                                          null
                                  ? '${value.favorite_actionlist![0].actionlist![widget.index!].like_num}'
                                  : '-',
                              ...
                              onPressed: () async {
                                await Provider.of<ChatProvider>(context,
                                    ...
                                    .get_action_msg(value
                                        .favorite_actionlist![0].actionlist[widget.index!]
                                        .id);
                              ...
                              child: Text(
                                value
                                        ...
                                        value
                                                ...
                                                .msg_num !=
                                            null
                                    ? '${value.favorite_actionlist![0].actionlist![widget.index!].msg_num}'
                                    : '-',
                                style: TextStyle(fontSize: 12),
                              ),
                            )
