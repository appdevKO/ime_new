                        ...
                        return topicindex == -1
                          ...
                          child: ListView.builder(
                            itemBuilder: (context, index) {
                              ...
                              correctindex = index;
                              return bubble(
                                value.o2ohistorymsg![correctindex],
                              );
                            },
                            reverse: true,
                          ...
                          child: ListView.builder(
                            itemBuilder: (context, index) {
                              int correctindex;
                              if (value.o2ohistorymsg!.isNotEmpty) {
                                //歷史訊息回傳[xx]-有歷史
                                if (topicindex == -1) {
                                  //沒當前 -純歷史
                                  correctindex = index;
                  ...
                  onTap: () {
                    if (myrecord == recordState.recording) {
                      stopmic(widget.chatroomid);
                        ...
                        recordState.recordnotsend) {} else {
                      startmic();
                      setState(() {
                        myrecord = recordState.recording;
                      });
