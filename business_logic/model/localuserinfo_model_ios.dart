...
UserInfoIOS userInfoIOSFromJson(String str) => UserInfoIOS.fromJson(json.decode(str));

String UserInfoIOSToJson(UserInfoIOS data) => json.encode(data.toJson());
...
class UserInfoIOS {
  ...
  factory UserInfoIOS.fromJson(Map<String, dynamic> json) => UserInfoIOS(
